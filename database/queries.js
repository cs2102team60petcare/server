module.exports = {
  ...
  seeMyBidsQuery: 'SELECT B.bid_id, S.service_id, B.pet_id, B.money, B.status, B.starting, B.ending, U.name FROM Bids B JOIN Services S on (B.service_id=S.service_id) join Users U on (S.caretaker_id=U.user_id) where B.owner_id=$1;',   
